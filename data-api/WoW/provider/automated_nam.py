...
class AutomatedCollectionProvider(BaseProvider):
    ...
    def pt_to_covjson(self,query_dict):
       ...
       output['domain']['axes']['x']['values']=[output['coords']['gridlat_0']['data']]
       del output['coords']['gridlat_0']['data']
       output['domain']['axes']['y']={}
       output['domain']['axes']['y']['values']=[output['coords']['gridlon_0']['data']]
       del output['coords']['gridlon_0']['data']
       output['ranges']={}
