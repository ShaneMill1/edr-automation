...
class TimeInterval(object):
    ...
    def get_is_valid(self, timepoint):
        """Return whether the timepoint is within for this interval."""
    ...
    def _get_is_in_bounds(self, timepoint):
        """Return whether the timepoint is within this interval."""
        if timepoint is None:
            return False
        if self.start_point is not None and timepoint < self.start_point:
            return False
...
class TimePoint(object):
    ...
    def get_datetime(self):
        """Get the TimePoint as a datetime value

        """
        strf = "%d/%m/%YT%H:%M:%S"
        return datetime.strptime(self.strftime(strf),strf)
